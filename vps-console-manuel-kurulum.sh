...
# VPS Console Manuel Kurulum Scripti
# Bu script VNC/Console üzerinden çalıştırılır (SSH çalışmıyorsa)

set -e

echo "========================================"
echo "VPS Console Manuel Email Kurulumu"
echo "========================================"
echo ""
...
PROTON_SMTP_USERNAME=$BRIDGE_USERNAME
PROTON_SMTP_PASSWORD=
PROTON_FROM_EMAIL=$BRIDGE_USERNAME
PROTON_FROM_NAME=PORNRAS
EOF
    echo "✅ .env dosyası oluşturuldu"
else
    echo "✅ .env dosyası mevcut, güncelleniyor..."
...
# 6. Bridge password sor
echo ""
echo "🔐 4. Bridge Password gerekli"
...
# 7. .env dosyasını göster
echo ""
echo "📄 5. Güncel .env içeriği:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
cat .env
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

# 8. Backend'i yeniden başlat
echo ""
echo "🔄 6. Backend yeniden başlatılıyor..."
if pm2 list | grep -q "adulttube-backend"; then
...
echo ""
echo "📊 7. Backend logları (son 20 satır):"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
